...
//TODO-REFLECT removed access modifiers to reuse in typechecker instance: private[runtime] trait ReflectSetup extends internal.SymbolTable {
trait ReflectSetup extends internal.SymbolTable {
