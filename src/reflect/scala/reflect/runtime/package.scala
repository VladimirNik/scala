...
package object runtime {
  ...
  import scala.reflect.internal.tools.nsc.{TypecheckerApi, TypecheckerImpl}

  //TODO-REFLECT changed to TypecheckerImpl
   ...
   * for more details.
   */
  lazy val universe: api.JavaUniverse with TypecheckerApi = new TypecheckerImpl //new runtime.JavaUniverse
