  ...
  override def typecheck(tree: Tree, mirror: Mirror): Tree = {
    ...
    if (mirror == rootMirror) {
      ...
      if (printLog) {
        ...
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$ val context = typecheckerContext")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println
      }
      ...
      if (printLog) {
        ...
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$ val newCont = namer.enterSym")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println
      }
      ...
      if (printLog) {
        ...
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$ val importer = tUniverse...")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println("$$$$$$$$$$$$$$$$$$$$$$$")
        println
      }
