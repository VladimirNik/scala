...
abstract class TreeInfo extends _root_.scala.reflect.internal.TreeInfo {
  val global: SymbolTable with Trees //nsc.ReflectGlobal
  import global._
  ...
  //TODO-REFLECT move to compiler's version of TreeInfo 
