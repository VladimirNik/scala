...
trait StdTags {
  ...
  lazy val tagOfFile = tagOfStaticClass[scala.reflect.internal.tools.nsc.io.File]
  lazy val tagOfDirectory = tagOfStaticClass[scala.reflect.internal.tools.nsc.io.Directory]
