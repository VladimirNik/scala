...
import scala.reflect.internal.tools.nsc.transform.patmat.{ TreeAndTypeAnalysis => RTreeAndTypeAnalysis }
import scala.tools.nsc.Global

trait TreeAndTypeAnalysis extends RTreeAndTypeAnalysis with Debugging {
